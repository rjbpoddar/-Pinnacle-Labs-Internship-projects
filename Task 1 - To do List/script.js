...
let items = [];//array for to-do-s
let count = 0;//COUNTER FOR ID
let lister = document.querySelector('ul');//checking for completed
let fltr = "all";//filter default value is 0(all)
...
addItem = () => {//ADD ITEM FROM FORM FUNCTION
    ...
    if(todo && priorityGet){//CHECK IF NOT EMPTY
        ...
        let item = {//new object to be added in array
            id: count,
            description: todo,
